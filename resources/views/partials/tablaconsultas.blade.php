                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead class="bg-gray-50 dark:bg-gray-800">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-3.5 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">Fecha de Atención</th>
                                ...
                                <td class="px-4 py-4 text-sm whitespace-nowrap">
                                 ...
                                 <td class="px-4 py-4 text-sm whitespace-nowrap">
                                    <div>
                                        ...
                                        <p class="text-gray-500 dark:text-gray-400">{{$consulta->created_at}}</p>
                                    </div>
                                </td>
                                <td class="px-4 py-4 text-sm whitespace-nowrap">
