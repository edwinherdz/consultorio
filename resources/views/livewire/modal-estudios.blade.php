<div>
    <button wire:click="$set('open',true)" class="rounded shadow flex items-center justify-center w-1/2 px-5 py-2 text-sm tracking-wide text-black transition-colors duration-200 bg-white-100 rounded-lg shrink-0 sm:w-auto gap-x-2 hover:bg-gray-200 dark:hover:bg-gray-500 dark:bg-gray-600 border border-gray-400">
            ...
            <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                <div class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                    ...
                    <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                        ...
                        @isset($estudio)
                        <button  wire:click="store()" type="button" class="inline-flex w-full justify-center rounded-md bg-green-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-green-500 sm:ml-3 sm:w-auto">Guardar</button>
                        @endisset
