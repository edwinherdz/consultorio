    ...
    <div class="sm:col-span-2 sm:col-start-1">
        ...
        <div class="flex flex-wrap mb-2 -mx-3">
            ...
            <div class="w-full px-3 mb-6 md:w-1/3 md:mb-0">
                ...
                <input disabled name="" value="{{ $datospacientes->csexo}}" class="block w-full px-4 py-3 leading-tight text-gray-700 border border-gray-200 rounded appearance-none disabled focus:outline-none focus:bg-white focus:border-gray-500" id="grid-zip" type="text" placeholder="indique la(s) alergia(s) del paciente">
            </div>
            <div class="w-full px-3 mb-6 md:w-1/3 md:mb-0">
                <label class="block mb-2 text-xs font-bold tracking-wide text-gray-700 uppercase" for="grid-zip">
                    Email
                </label>
                <input disabled name="" value="{{ $datospacientes->cemail}}" class="block w-full px-4 py-3 leading-tight text-gray-700 border border-gray-200 rounded appearance-none disabled focus:outline-none focus:bg-white focus:border-gray-500" id="grid-zip" type="text" placeholder="indique la(s) alergia(s) del paciente">
            </div>
        </div>
