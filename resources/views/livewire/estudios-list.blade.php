    ...
    <div>
        <section class="container px-4 mx-auto">
            ...
            <div class="relative flex items-center mt-4 md:mt-0">
                ...
                <input wire:model="search" placeholder="Buscar Estudio Médico" type="search" class="block w-full py-1.5 pr-5 text-gray-700 bg-white border border-gray-200 rounded-lg md:w-80 placeholder-gray-400/70 pl-11 rtl:pr-11 rtl:pl-5 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                                    <tr>
                                        ...
                                        <td class="px-4 py-4 text-sm whitespace-nowrap">
                                            <div>
                                                <h4 class="text-gray-700 dark:text-gray-200">{{$estudio->cdescripcion}} </h4>
                                            </div>
                                        </td>
                                        <td class="px-4 py-4 text-sm whitespace-nowrap">
                                            <div>
                                        ...
                                        <td class="px-4 py-4 text-sm whitespace-nowrap">
                                            <div class="flex items-center gap-x-6">
                                                        ...
                                                        <ul class="transition-colors duration-200 text-sky-500 dark:hover:text-indigo-500 dark:text-gray-300 hover:text-indigo-500 focus:outline-none" onclick="window.location.href='{{route('estudios.show',$estudio)}}'">
                                                            <button class="rounded shadow flex items-center justify-center w-1/2 px-5 py-2 text-sm tracking-wide text-black transition-colors duration-200 bg-white-100 rounded-lg shrink-0 sm:w-auto gap-x-2 hover:bg-gray-200 dark:hover:bg-gray-500 dark:bg-gray-600 border border-gray-400" >
                                                        ...
                                                        <ul class="transition-colors duration-200 text-sky-500 dark:hover:text-indigo-500 dark:text-gray-300 hover:text-indigo-500 focus:outline-none" onclick="window.location.href='{{route('estudios.edit',$estudio)}}'">
